...
def train_LFNet(
    ...
    print('='*40)
    print('... Loading data')
    train_path = 'LFNet_train_c1_C_s%d_l%d_f%d_p%d.mat' %(sample_num,length,factor,patch_size)
    options['train_path'] = train_path
    saveto='LFNet_CN_with_IMsF_f%d_l%d' %(factor,length)  # The best model will be saved there
    options['savetoModel'] = saveto
    model_path='LFNet_with_IMsF_f%d_l%d_0204.npy' %(factor,length) # The model path
