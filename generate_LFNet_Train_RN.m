...
train_path = sprintf('LFNet_train_c1_R_s%d_l%d_f%d_p%d.mat',sample_num,length,scale,patch_size);
...
for k = 1 : sample_num
    ...
    for i = 1+border:2:angular_size-border
        for j = 1+border: angular_size-border
